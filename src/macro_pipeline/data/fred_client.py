...
class FREDClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not self.api_key:
            raise ValueError("Se requiere FRED_API_KEY en variables de entorno o como argumento.")
    ...
    def get_series_observations(self, series_id: str, **kwargs: Any) -> pd.DataFrame:
        ...
        Args:
            ...
            **kwargs: Parámetros adicionales para la API (observation_start, frequency, etc).
