...
class AlphaVantageClient:
    ...
    def __init__(self, api_key: Optional[str] = None):
        ...
        if not self.api_key:
            raise ValueError("Se requiere ALPHA_VANTAGE_API_KEY en variables de entorno o como argumento.")
    ...
    def get_daily_prices(self, symbol: str, outputsize: str = "compact", **kwargs: Any) -> pd.DataFrame:
        """
        Obtiene los precios históricos diarios. outputsize puede ser 'compact' (100 días) o 'full'.
        """
        params = {
        ...
        if "Information" in data and "rate limit" in data["Information"].lower():
            ...
            raise AlphaVantageClientError("Rate limit excedido en Alpha Vantage (máximo llamadas/min o /día).")
