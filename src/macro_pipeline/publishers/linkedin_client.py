...
class LinkedInClient:
    ...
    def __init__(self, access_token: Optional[str] = None, person_urn: Optional[str] = None):
        ...
        if not self.access_token or not self.person_urn:
            raise ValueError("Faltan credenciales de LinkedIn (LINKEDIN_ACCESS_TOKEN o LINKEDIN_PERSON_URN).")
    ...
    def post_text(self, text: str) -> Dict[str, Any]:
        ...
        payload = {
            "author": self.person_urn, # Formato: urn:li:person:12345 o urn:li:organization:67890
