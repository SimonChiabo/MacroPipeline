...
def test_get_historical_prices_empty_raises(mock_get, fmp_client):
    """Lista vacía debe lanzar FMPClientError, no un DataFrame vacío silencioso."""
    _mock_json(mock_get, [])
...
def test_get_historical_prices_error_payload_raises(mock_get, fmp_client):
    """FMP a veces devuelve 200 con un dict de error: debe fallar limpio."""
    ...
    _mock_json(
        ...
        [
            ...
            },
            {
                ...
                "epsActual": 0.03,
                "epsEstimated": 0.17,
                "revenueActual": 149204000000,
                "revenueEstimated": 145781000000,
            },
        ],
    )
